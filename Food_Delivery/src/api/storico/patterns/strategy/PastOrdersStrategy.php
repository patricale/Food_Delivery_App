...
/**
 * CLASSE: PastOrdersStrategy
 * Strategia: Recupera solo gli ordini CONCLUSI (Storico).
 * Path: src/api/storico/patterns/strategy/PastOrdersStrategy.php
 */
class PastOrdersStrategy implements IOrderFetchStrategy {
    public function fetch(PDO $conn, int $userId): array {
        ...
        $sql = "SELECT 
                ...
                WHERE o.id_cliente = :userId 
                  AND o.stato IN ('ritirato', 'rifiutato', 'nonRitirato')
